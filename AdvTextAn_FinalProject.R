...
RawData = read.csv("C:/Users/Shravya Mandava/Desktop/wikipedia.annotated_train.csv")
View(RawData)
...
names(FinalFile)[1]<-paste("Request")
names(FinalFile)[2]<-paste("Politeness_result")
names(FinalFile)[3]<-paste("Probability")

View(FinalFile)

write.xlsx(FinalFile, "C:/Users/Shravya Mandava/Desktop/Results.xlsx")
